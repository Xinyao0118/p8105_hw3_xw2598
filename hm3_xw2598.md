...
![](hm3_xw2598_files/figure-markdown_github/q3_q3-1.png) Comments: (1)From the plot we can see the Tmin had a hign density in (-15,15), Tmax had a hign density in (0,30). And excluding outliers, Tmin mainly ranged from (-45,45), Tmax mainly ranged from (-30,40). We can also make a stardard for excluding outliers in this plot because the whole dara were crowded, those obviously were out of range can be seen as outliers.
